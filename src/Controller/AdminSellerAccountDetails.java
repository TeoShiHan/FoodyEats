...
public class AdminSellerAccountDetails implements Initializable {
    ...
    @FXML
    private Label linkLogout, lblSellerAccountDetails, lblDateReg, lblName, lblEmail, lblMobileNo, lblNRIC,
            lblLicenseNo, lblBankAccNo, lblAddress, lblShopName, lblShopTel, lblShopAddress, lblShopDeliveryFee,
            lblShopDateCraeted;
    @FXML
    private ImageView iconProfile, iconHome, iconBack;
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            shopImg.setImage(
                    new Image(new FileInputStream(Paths.get("").toAbsolutePath().toString().replaceAll("\\\\", "/")
                            + "/src" + data.getSeller().getShop().getImgPath())));
